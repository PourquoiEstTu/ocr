...
Our final model implementation was using PyTorch based on a multi-layer 
CNN architecture. 
...
Training was done with an 80/20 training-test split where the dataset was 
randomized before being split. A batch size of 16 was used with a 0.03 
...
90\%. It clearly performs much better than the previous model. 
...
and takes whole PDF documents as input. We use a table sourced from 
Mistral AI's research into developing their own OCR model. They compare 
