...
precision of 91\% and the weighted averaged is 91\%. This easily beats the baseline on this dataset which is ?? 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{cnn_confusion_matrix.png}
